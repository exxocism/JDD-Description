...
```
- `--dangerously-skip-permissions` `--yolo` 등 Permission All 옵션을 적극 활용하자. alias 를 걸면 더욱 좋다.
어차피 컴퓨터에 별거 없잖아?

- 그건 토큰 다 썼다고 해라.

- 그건 다음 모델이 나오면 만든다고 해라.
...
- 모델 선택 기준은 arXiv 최신 날짜다.

- Metric은 하나만 본다. 여러 개 보면 헷갈린다.
```
...
# Skills
대 AI 에이전트 시대, 누구나 쉽게 JDD 실천가능하다

`npx skills add Lee-WonJun/JDD-Description`

<img width="989" height="492" alt="image" src="https://github.com/user-attachments/assets/53ddb088-e653-49b5-962b-d5b9741c8014" />
